...
function StockOut() {
  ...
  const handleAddEntry = (e) => {
    ...
    setStockOutList([newEntry, ...stockOutList]);
    setForm({
      productName: "",
      quantity: "",
      recipient: "",
  ...
  const handleDelete = (id) =>
    setStockOutList(stockOutList.filter((item) => item.id !== id));
  ...
  const filtered = stockOutList.filter(
    (entry) =>
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow text-gray-800">
      ...
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-md font-semibold text-blue-800">Stock Out Entries</h3>
        <input
          type="text"
